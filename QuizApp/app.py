...
if uploaded:
    ...
    for i, q in enumerate(quiz):
        ...
        if q["multi"]:
            ...
            # Nếu chưa chọn gì thì xóa khỏi progress
            if selected:
        ...
        # ===== MỘT ĐÁP ÁN =====
            ...
            # Thêm lựa chọn rỗng để thể hiện "chưa trả lời"
            ...
            # Chỉ hiển thị đúng/sai khi đã chọn
            if choice != "-- Chưa chọn --":
                if q["correct"]:
